...
import 'package:shopping_cart/src/data_class.dart';
import 'package:shopping_cart/src/second_page.dart';
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                              onTap: (){
                                Get.to(()=>SecondPage(), transition: Transition.upToDown, duration: const Duration(seconds: 1));
                              },
                              child: const Text("Next Page", style: TextStyle(fontSize: 20, color: Colors.white),)),
                          const Spacer(),
